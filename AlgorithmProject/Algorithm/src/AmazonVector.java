 ...
 * *********************************************************************************
 *  * ***************************************Note*************************************
 * Vector is slower that array list since it doesn't allow concurrent operations
 * while array list does. For a single threaded program I would prefer arrayList to
 * a vector
 * *********************************************************************************
 */
public class AmazonVector {
    ...
    public class Movie {
        ...
        private Vector<Movie> similarMovies;

        public Movie(int movieId, float rating) {
            this.movieId = movieId;
            this.rating = rating;
            this.explored = false;
            similarMovies = new Vector<Movie>();
        }
    ...
    public List<Movie> getMovieRecommendations(Movie m, int topRecommendation){
        ...
        java.util.Queue<Movie> q = new java.util.LinkedList<Movie>();
